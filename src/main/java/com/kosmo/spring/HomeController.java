...
public class HomeController {
	...
	요청을 처리할 메서드의 이름은 해당 클래스내부에서 중복되지 않는 정도의 이름을
	사용하면 된다. 
	...
	public String helloSpring(Model model) {
		...
		4.요청을 처리한다. 
			...
			속성을 저장하고 View로 전달한다. 사용법은 거의 동일하다. 
		 */		
		...
		해당뷰의 이름을 ViewResolver가 조립하여 최종적으로 뷰를 웹브라우저에 출력한다. 
		설정은 servlet-context.xml에서 할수있다. 
		 */
		return "HelloSpring";
	}
